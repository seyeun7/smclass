    # 변수 3종류
    # 지역 변수 : 함수내에 선언된 변수, 함수가 종류가 되면 사라짐.
    # 인스턴스 변수 : 객체선언할때 만들어짐, 각각의 객체마다 변수가 생성됨.
    # -사용방법 : 참조변수명.변수명
    # 클래스 변수 : 객체가 선언되지않아도 만들어짐, 모든 객체가 공통으로 사용
    # -사용방법 : 클래스명.변수명
...
class Student:
    ...
    def __init__(self,name,kor,eng,math):  
        ...
        self.name = name # 인스턴스 변수 : 참조변수명.변수명 ,# 함수에는 self가 꼭 있어야함 # self가 없으면 class에서 변수를 만들어주지않음 
        self.kor = kor
        self.eng = eng
        self.math = math
        Student.count += 1
...
# s1 = Student(10)
# print(s1.no)
# Student.kor = 50 # Student로 하면 공용으로 사용되서 변경이 됨
# # s1.kor = 50  -> 변하지 않고 그대로 100임
...
# -----------
# s1 = Student() # 객체선언 (아무것도 없는 이것만 가능함)
# s1.no = 1
# s1.name = "홍길동"
# print(s1)
# print(s1.name)

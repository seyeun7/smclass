# 웹스크래핑 세팅
import requests
res = requests.get("http://www.google.com/")  # html소스를 가져옴.
res = requests.get("http://www.naver.com/")  # html소스를 가져옴.
# res = requests.get("https://www.melon.com/index.htm") # html소스를 가져옴.  # 406

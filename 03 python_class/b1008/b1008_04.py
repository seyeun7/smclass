...
# {}를 사용하고 키와 벨류로 이루워져있다.
# 한글 변수 사용하면 약간 에러 나올수 있어서 영문 변수 사용을 권장한다
# 리스트 타입
# 튜플 타입  - 수정 불가
# 딕셔너리 타입


# dic1 = {"번호":1,"이름":"홍길동","kor":100,"eng":200}
...
# # print(dic1["학번"]) # 에러
# print(dic1.get("이름"))
# print(dic1.get("학번")) # 없는 키를 입력하면 None, 에러는 나지않음.

# if dic1.get("d이름") != None:
#     print(dic1.get("이름"))
...
# # class객체 -> 리스트 타입 변경
# print(dic1.keys())
# # print(dic1.keys()[0[]) # class객체 타입이기레 index값 없음

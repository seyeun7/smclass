...
b = "12.3"
# print(type(int(b))) #에러 - 소수점이 있는 문자열 숫자는 float 변경해야함.
...
# 문자열 슬라이싱
str1 = "안녕하세요.반갑습니다." # 문자열 자체를 리스트 형태로 봄 [안녕하세요.반갑습니다.] = [012345678910]
...
# 논리연산자 and(그리고)둘다 참이여야 참 or(또는)둘중 하나만 참이어도 참 not(부정)참이면 거짓 거짓이면 참

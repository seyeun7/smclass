...
for i in range(2,5): # 시작:2부터 5전까지 반복
    print(i)
...
# enumerate  index번호를 추가해서 가져올수 잇음.
...
# list 추가 - append(뒤에추가),insert(원하는위치 추가) 
...
#문자열 슬라이싱
# str = "좋은 하루되세요. 많은 행복받으세요. 많은 감사! 많은 돈" #좋 = [0] 돈 = [-1]
# print(len(str))
